...
//个人测试
//ACCESS_ID
define('OSS_ACCESS_ID', '1B7sjWW5nwg6srnv');

//ACCESS_KEY
define('OSS_ACCESS_KEY', 'qLcYJD8sUnehCXeVY6hjbrsGFyIyEX');

define('OSS_BUCKET','flycat');
...
define('OSS_URL','https://flycat.oss-cn-hangzhou.aliyuncs.com');
//是否记录日志
