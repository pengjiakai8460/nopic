<?php
namespace Addons\Aliyun\OSS\SDK2;

use Addons\Aliyun\OSS\SDK2\Core\MimeTypes;
use Addons\Aliyun\OSS\SDK2\Core\OssException;
use Addons\Aliyun\OSS\SDK2\Http\RequestCore;
use Addons\Aliyun\OSS\SDK2\Http\RequestCore_Exception;
use Addons\Aliyun\OSS\SDK2\Http\ResponseCore;
use Addons\Aliyun\OSS\SDK2\Model\CorsConfig;
use Addons\Aliyun\OSS\SDK2\Model\CnameConfig;
use Addons\Aliyun\OSS\SDK2\Model\LoggingConfig;
use Addons\Aliyun\OSS\SDK2\Model\LiveChannelConfig;
use Addons\Aliyun\OSS\SDK2\Model\LiveChannelInfo;
use Addons\Aliyun\OSS\SDK2\Model\LiveChannelListInfo;
use Addons\Aliyun\OSS\SDK2\Result\AclResult;
use Addons\Aliyun\OSS\SDK2\Result\BodyResult;
use Addons\Aliyun\OSS\SDK2\Result\GetCorsResult;
use Addons\Aliyun\OSS\SDK2\Result\GetLifecycleResult;
use Addons\Aliyun\OSS\SDK2\Result\GetLoggingResult;
use Addons\Aliyun\OSS\SDK2\Result\GetRefererResult;
use Addons\Aliyun\OSS\SDK2\Result\GetWebsiteResult;
use Addons\Aliyun\OSS\SDK2\Result\GetCnameResult;
use Addons\Aliyun\OSS\SDK2\Result\HeaderResult;
use Addons\Aliyun\OSS\SDK2\Result\InitiateMultipartUploadResult;
use Addons\Aliyun\OSS\SDK2\Result\ListBucketsResult;
use Addons\Aliyun\OSS\SDK2\Result\ListMultipartUploadResult;
use Addons\Aliyun\OSS\SDK2\Model\ListMultipartUploadInfo;
use Addons\Aliyun\OSS\SDK2\Result\ListObjectsResult;
use Addons\Aliyun\OSS\SDK2\Result\ListPartsResult;
use Addons\Aliyun\OSS\SDK2\Result\PutSetDeleteResult;
use Addons\Aliyun\OSS\SDK2\Result\DeleteObjectsResult;
use Addons\Aliyun\OSS\SDK2\Result\CopyObjectResult;
use Addons\Aliyun\OSS\SDK2\Result\CallbackResult;
use Addons\Aliyun\OSS\SDK2\Result\ExistResult;
use Addons\Aliyun\OSS\SDK2\Result\PutLiveChannelResult;
use Addons\Aliyun\OSS\SDK2\Result\GetLiveChannelHistoryResult;
use Addons\Aliyun\OSS\SDK2\Result\GetLiveChannelInfoResult;
use Addons\Aliyun\OSS\SDK2\Result\GetLiveChannelStatusResult;
use Addons\Aliyun\OSS\SDK2\Result\ListLiveChannelResult;
use Addons\Aliyun\OSS\SDK2\Result\AppendResult;
use Addons\Aliyun\OSS\SDK2\Model\ObjectListInfo;
use Addons\Aliyun\OSS\SDK2\Result\UploadPartResult;
use Addons\Aliyun\OSS\SDK2\Model\BucketListInfo;
use Addons\Aliyun\OSS\SDK2\Model\LifecycleConfig;
use Addons\Aliyun\OSS\SDK2\Model\RefererConfig;
use Addons\Aliyun\OSS\SDK2\Model\WebsiteConfig;
use Addons\Aliyun\OSS\SDK2\Core\OssUtil;
use Addons\Aliyun\OSS\SDK2\Model\ListPartsInfo;
   ...
   public function getLiveChannelHistory($bucket, $channelName, $options = NULL)
    ...
    public function putObject($bucket, $object, $content, $options = NULL)
    {
        ...
        if (isset($options[self::OSS_CALLBACK]) && !empty($options[self::OSS_CALLBACK])) {
            $result = new \Addons\Aliyun\OSS\SDK2\Result\CallbackResult($response);
        } else {
            $result = new \Addons\Aliyun\OSS\SDK2\Result\PutSetDeleteResult($response);
        }
